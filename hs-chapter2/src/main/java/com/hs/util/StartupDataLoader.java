...
public class StartupDataLoader implements ServletContextListener {
   ...
   public void setData(Session session) {
      ...
      Item eReader = new Item(
         "E-Book Reader",
         "book.jpg",
         "Read books on your computer, or on the go from your mobile Category with this powerful e-reader app.  We recommend \"Hibernate Search by Example\", from Packt Publishing.");
